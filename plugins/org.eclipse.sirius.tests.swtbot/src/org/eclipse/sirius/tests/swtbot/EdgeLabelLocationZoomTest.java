...
public class EdgeLabelLocationZoomTest extends AbstractSiriusSwtBotGefTestCase {
    ...
    public void testEdgeLabelLocationWithZoom() throws Exception {
        ...
        // assertEquals(failureMessagePos, labelBounds.preciseX(), 1372., 2.);
        // assertEquals(failureMessagePos, labelBounds.preciseY(), 1055., 2.);
        // assertEquals(failureMessageSize, labelBounds.preciseWidth(), 135., 2.);
        // assertEquals(failureMessageSize, labelBounds.preciseHeight(), 23., 2.);
    }
